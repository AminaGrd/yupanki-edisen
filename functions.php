...
function register_assets(){
	...
	wp_enqueue_style(
		'validate-account-css',
		get_stylesheet_directory_uri().'/assets/css/childstorefront/validate-account.css',
		array(),
		'1.0'
    );
	wp_enqueue_style(
		'error-404-css',
		get_stylesheet_directory_uri().'/assets/css/childstorefront/error-404.css',
		array(),
		'1.0'
    );
	// wp_enqueue_script(
